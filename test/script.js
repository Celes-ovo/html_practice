...
const points9 = [
  ...
  { x: landmarkCoords['Maxillary first molar'][0],
    y: landmarkCoords['Maxillary first molar'][1] - 30*ratio},
  // { x: 338, y: 363 },
  { x: landmarkCoords['Maxillary first molar'][0],
    y: landmarkCoords['Maxillary first molar'][1] },
  
    // { x: 322, y: 369 },
  { x: landmarkCoords['Maxillary first molar'][0] - 20*ratio,
    y: landmarkCoords['Maxillary first molar'][1] + 5*ratio},
  // { x: 310, y: 364 },
  { x: landmarkCoords['Maxillary first molar'][0] - 25*ratio,
    y: landmarkCoords['Maxillary first molar'][1] - 5*ratio},
  // { x: 298, y: 363 },
  { x: landmarkCoords['Maxillary first molar'][0] - 35*ratio,
    y: landmarkCoords['Maxillary first molar'][1]},
  
  // { x: 289, y: 343 },
  { x: landmarkCoords['Maxillary first molar'][0] - 50*ratio,
    y: landmarkCoords['Maxillary first molar'][1] - 15*ratio},
  // { x: 304, y: 320 },
  { x: landmarkCoords['Maxillary first molar'][0] - 30*ratio,
    y: landmarkCoords['Maxillary first molar'][1] - 45*ratio},
]
...
const points10 = [
  ...
  // { x: 313, y: 301 },
  { x: landmarkCoords['Maxillary first molar'][0] - 35*ratio,
    y: landmarkCoords['Maxillary first molar'][1] - 40*ratio},
  // { x: 324, y: 281 },
  { x: landmarkCoords['Maxillary first molar'][0] - 12*ratio,
    y: landmarkCoords['Maxillary first molar'][1] - 80*ratio},
  // { x: 327, y: 297 },
  { x: landmarkCoords['Maxillary first molar'][0] - 9*ratio,
    y: landmarkCoords['Maxillary first molar'][1] - 65*ratio},
  // { x: 328, y: 314 },
  { x: landmarkCoords['Maxillary first molar'][0] - 15*ratio,
    y: landmarkCoords['Maxillary first molar'][1] - 35*ratio},
  // { x: 337, y: 299 },
  { x: landmarkCoords['Maxillary first molar'][0] - 2*ratio,
    y: landmarkCoords['Maxillary first molar'][1] - 65*ratio},
  // { x: 346, y: 288 },
  { x: landmarkCoords['Maxillary first molar'][0] + 10*ratio,
    y: landmarkCoords['Maxillary first molar'][1] - 70*ratio},
  // { x: 345, y: 312 },
  { x: landmarkCoords['Maxillary first molar'][0],
    y: landmarkCoords['Maxillary first molar'][1] - 30*ratio},
  // { x: 341, y: 334 },
...
const points11 = [
  // { x: 318, y: 397 },
  { x: landmarkCoords['Mandibular first molar'][0] - 12*ratio,
    y: landmarkCoords['Mandibular first molar'][1] + 15*ratio},
  // { x: 328, y: 382 },
  { x: landmarkCoords['Mandibular first molar'][0],
    y: landmarkCoords['Mandibular first molar'][1]},
  // { x: 323, y: 375 },
  { x: landmarkCoords['Mandibular first molar'][0] - 15*ratio,
    y: landmarkCoords['Mandibular first molar'][1] - 10*ratio},
  // { x: 308, y: 370 },
  { x: landmarkCoords['Mandibular first molar'][0] - 27*ratio,
    y: landmarkCoords['Mandibular first molar'][1] - 5*ratio},
  // { x: 294, y: 364 },
  { x: landmarkCoords['Mandibular first molar'][0] - 35*ratio,
    y: landmarkCoords['Mandibular first molar'][1] - 20*ratio},
  // { x: 278, y: 368 },
  { x: landmarkCoords['Mandibular first molar'][0] - 50*ratio,
    y: landmarkCoords['Mandibular first molar'][1] - 15*ratio},
  // { x: 273, y: 386 },
  { x: landmarkCoords['Mandibular first molar'][0] - 55*ratio,
    y: landmarkCoords['Mandibular first molar'][1] + 5*ratio},
]
...
const points12 = [
  ...
  { x: landmarkCoords['Mandibular first molar'][0] - 12*ratio,
    y: landmarkCoords['Mandibular first molar'][1] + 15*ratio},
  // { x: 304, y: 422 },
  { x: landmarkCoords['Mandibular first molar'][0] - 20*ratio,
    y: landmarkCoords['Mandibular first molar'][1] + 25*ratio},
  // { x: 284, y: 450 },
  { x: landmarkCoords['Mandibular first molar'][0] - 40*ratio,
    y: landmarkCoords['Mandibular first molar'][1] + 70*ratio},
  // { x: 286, y: 428 },
  { x: landmarkCoords['Mandibular first molar'][0] - 45*ratio,
    y: landmarkCoords['Mandibular first molar'][1] + 55*ratio},
  // { x: 289, y: 409 },
  { x: landmarkCoords['Mandibular first molar'][0] - 35*ratio,
    y: landmarkCoords['Mandibular first molar'][1] + 20*ratio},
  // { x: 273, y: 424 },
  { x: landmarkCoords['Mandibular first molar'][0] - 65*ratio,
    y: landmarkCoords['Mandibular first molar'][1] + 50*ratio},
  // { x: 255, y: 437 },
  { x: landmarkCoords['Mandibular first molar'][0] - 70*ratio,
    y: landmarkCoords['Mandibular first molar'][1] + 55*ratio},
  // { x: 265, y: 408 },
  { x: landmarkCoords['Mandibular first molar'][0] - 70*ratio,
    y: landmarkCoords['Mandibular first molar'][1] + 40*ratio},
  // { x: 273, y: 386 },
  { x: landmarkCoords['Mandibular first molar'][0] - 55*ratio,
    y: landmarkCoords['Mandibular first molar'][1] + 5*ratio},
]
